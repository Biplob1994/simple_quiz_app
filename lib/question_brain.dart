import 'package:simple_quiz_app/questions.dart';
...
class QuestionBrain {
  ...
  List<Questions> _questionBank = [
    ...
    Questions(
        ...
        true),
    Questions('Are you sure of doing th job?', true),
    Questions('Is your capital dhaka?', false),
    Questions('Are you married ?', false),
    Questions('do you love to play?', true),
  ];
